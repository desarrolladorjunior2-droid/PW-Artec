...
export function Footer() {
  return (
    <footer style={sectionTint("var(--brand-indigo)")} className="section-tinted relative overflow-hidden section-edge-fade-top bg-[var(--surface-glass)] backdrop-blur-xl">
