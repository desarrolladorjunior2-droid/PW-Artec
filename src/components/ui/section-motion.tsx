      ...
      {BUBBLES.map((b, i) => (
        <span
          ...
          style={{
            ...
            width: b.size * 1.25,
            height: b.size * 1.25,
            background: `radial-gradient(circle at 35% 30%, color-mix(in srgb, ${col(i + 2)} 58%, transparent), color-mix(in srgb, ${col(i + 2)} 26%, transparent) 70%)`,
            boxShadow: `0 0 10px color-mix(in srgb, ${col(i + 2)} 18%, transparent)`,
