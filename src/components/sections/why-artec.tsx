...
export function WhyArtec() {
  return (
    <section style={sectionTint("var(--brand-blue)")} className="section-tinted relative overflow-hidden section-overlap bg-[var(--background-glass)] py-24 backdrop-blur-xl md:py-32">
